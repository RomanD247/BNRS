        ...
        with SessionLocal() as fresh_db:
            with ui.dialog() as dialog, ui.card().style('width: 600px; height: 800px'):
                with ui.row().classes('w-full justify-between items-center no-wrap'):
                    ui.label('Select equipment to edit').classes('text-h6 q-mb-md')
    ...
    try:
        ...
        with SessionLocal() as fresh_db:
            ...
            def refresh_nfc_label():
                ...
                nfc_text.set_text('NFC Tag scanned' if has_code else 'NFC Tag: Not set')
            ...
            with ui.dialog() as edit_dialog, ui.card().classes('w-96'):
                ...
                with ui.row().classes('w-full justify-between items-center q-mb-md'):
                    ...
                    with ui.row().classes('items-center gap-1'):
                        ...
                        nfc_text = ui.label('NFC Tag: Not set').classes('text-bold')
                    refresh_nfc_label()
